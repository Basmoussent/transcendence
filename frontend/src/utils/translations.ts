export const translations = {
  fr: {
    ...
    chat: {
      ...
      selectFriendToChat: "Boite de réception",
    ...
    matchmaking: {
      ...
      chooseGameType: "Choisissez le type de jeu",
      ...
      availableRoomsTitle: "Salles disponibles",
      noActiveGamesText: "Aucune partie active",
      createGameToStartText: "Créez une partie pour commencer"
    },
    game: {
      home: "Accueil",
      ...
      tournamentLobby: "Salon du Tournoi",
      playersLobby: "Lobby des Joueurs",
      quarterFinals: "Quarts de finale",
      semiFinals: "Demi-finales",
      champion: "Champion",
      addPlayer: "Ajouter un joueur",
      reset: "Réinitialiser",
      startTournamentBtn: "Démarrer le tournoi",
  ...
  en: {
    ...
    matchmaking: {
      ...
      chooseGameType: "Choose the game type",
      gameType: "Game Type",
      pong: "Pong",
      block: "Block",
      ...
      createGameToStart: "Create a game to start",
      joinTitle: "Join Game",
      availableRoomsTitle: "Available Rooms",
      noActiveGamesText: "No active games",
      createGameToStartText: "Create a game to start"
    },
    game: {
      blockGame: "Block Game",
      pongGame: "Pong Game",
  ...
  es: {
    ...
    chat: {
      ...
      selectFriendToChat: "Buzón de entrada",
    ...
    matchmaking: {
      ...
      chooseGameType: "Elige el tipo de juego",
      ...
      createGameToStart: "Crea una partida para empezar",
      joinTitle: "Unirse a una partida",
      availableRoomsTitle: "Salas disponibles",
      noActiveGamesText: "No hay partidas activas",
      createGameToStartText: "Crea una partida para empezar"
    },
    game: {
      ...
      tournamentLobby: "Lobby del Torneo",
      playersLobby: "Lobby de Jugadores",
      quarterFinals: "Cuartos de final",
      semiFinals: "Semifinales",
      champion: "Campeón",
      addPlayer: "Agregar jugador",
      reset: "Reiniciar",
      startTournamentBtn: "Iniciar Torneo",
